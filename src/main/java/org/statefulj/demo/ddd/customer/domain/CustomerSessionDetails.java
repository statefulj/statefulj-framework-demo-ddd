...
public class CustomerSessionDetails implements UserDetails {
	...
	public String getUsername() {
		return this.customer.getContactEmail().getEmail();
	}
	...
	public boolean isEnabled() {
		return !Customer.DELETED.equals(customer.getState());
	}
